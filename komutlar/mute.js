...
module.exports.run = async (bot, message, args) => {
  ...
  if (!muterole) {
    ...
    const muteembed = new Discord.RichEmbed()
            .setAuthor(' EYLEM | Susturma', `https://images-ext-2.discordapp.net/external/Wms63jAyNOxNHtfUpS1EpRAQer2UT0nOsFaWlnDdR3M/https/image.flaticon.com/icons/png/128/148/148757.png`)
