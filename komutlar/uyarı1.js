...
module.exports.run = async (bot, message, args) => {
    ...
    let muterole = message.guild.roles.find(`name`, "Uyarı 1");
    if(args[0] == "help"){
  ...
  if (!muterole) {
    ...
    const muteembed = new Discord.RichEmbed()
            .setAuthor(' Uyarı 1', `https://cdn.pixabay.com/photo/2012/04/14/17/05/warning-34621_960_720.png`)
...
exports.conf = {
    enabled: true,
    guildOnly: false,
    aliases: ["Uyarı", "uyarı1", "uyar1", "Uyarı1"],
    permLevel: 3
  };
